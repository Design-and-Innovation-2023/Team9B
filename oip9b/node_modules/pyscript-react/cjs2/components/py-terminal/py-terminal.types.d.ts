...
export type PyTerminalPropertiesBase = Omit<ReactElementProps<DetailedHTMLProps<HTMLAttributes<HTMLElement>, HTMLElement>>, "children"> & {
    auto?: boolean;
};
export type PyTerminalProperties<T> = T extends infer T ? T & PyTerminalPropertiesBase : PyTerminalPropertiesBase;
