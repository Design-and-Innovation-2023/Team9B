...
export type PyEnvPropertiesBase = Omit<ReactElementProps<DetailedHTMLProps<HTMLAttributes<HTMLElement>, HTMLElement>>, "children"> & {
    children: string | string[] | Set<string> | PyEnvChildrenAsObject;
};
export type PyEnvProperties<T> = T extends infer T ? T & PyEnvPropertiesBase : PyEnvPropertiesBase;
