...
export type PyReplPropertiesBase = Omit<ReactElementProps<DetailedHTMLProps<HTMLAttributes<HTMLElement>, HTMLElement>>, "children"> & {
    autoGenerate?: boolean;
    children?: string;
};
export type PyReplProperties<T> = T extends infer T ? T & PyReplPropertiesBase : PyReplPropertiesBase;
